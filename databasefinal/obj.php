...
<div id="mainWrapper">
    ...
    <div id="headerLinks"><a href="logout.php?logout=1" title="Logout/Register">Logout | 你好 <?php echo $_SESSION["email"]?></a>
      <a href="receipt.php" title="Cart"><i class="fas fa-receipt" style="color: #FFAC55; position: relative; right: 30px;">購買紀錄</i></a>
    </div> 
  </header>
  ...
  <div id="content">
    ...
    <?php
      ...
      <div class="productRow"><!-- Each product row contains info of 3 elements -->
          ...
          <form action="buy.php" name="form_buy" id="form_buy" method="get" enctype="multipart/form-data">
    ...
    <div >
      <p style="color: black; font-size:18px;">Develop By 
        <i class="fab fa-html5 iconsize2" style="color: coral;"></i><i class="fab fa-css3-alt iconsize2" style="color: #0277bd ;"></i>
        <i class="fab fa-js iconsize2" style="color: darkorange;"></i><i class="fab fa-php iconsize2"style="color: cornflowerblue;"></i></p>
    </div>
